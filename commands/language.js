...
export const language = (player, command) => {
  ...
  if (command[1] == undefined) {
    ...
    Hutao.World.showHelp(player,
      [`${setting.default.data.commands.normalPrefix}language §aen`, `Change your language to §eEnglish`],
      [`${setting.default.data.commands.normalPrefix}language §azh-ch`, `更改你的语言成§e简体中文`],
      [`${setting.default.data.commands.normalPrefix}language §azh-tw`, `更改你的語言成§e繁體中文`]
    )
